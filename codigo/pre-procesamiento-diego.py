...
# cargar archivos csv
data = pd.read_csv('C:/Users/Diego/Desktop/Ciencia-de-datos---Proyecto/codigo/BD/RetailOnline.csv', sep=',')
...
Arch_Dat_Falt.write("data: \n")
Arch_Dat_Falt.write(str(Verificar_CSV(data, Arch_Dat_Falt)))
...
Arch_1D_Original.write("data: \n")
Arch_1D_Original.write(str(TipoDatos(data, Arch_1D_Original)))
...
Arch_No_Comprados.write(str(NoComprados(RetailOnline, Arch_No_Comprados)))
Arch_No_Comprados.close()

#se hacen los procesos de 1D con los datos NaN = -1
Arch_1D_1 = open('Archivos/Archivo_1D_1', 'a')
Arch_1D_1.write("data: \n")
Arch_1D_1.write(str(TipoDatos(data, Arch_1D_1)))
...
#rch_1D_1.write(str(TipoDatos(products, Arch_1D_1)))
...
Arch_1D_Eliminados.write("datos: \n")
Arch_1D_Eliminados.write(str(TipoDatos(data, Arch_1D_Eliminados)))
...
#rchivo_2D_Apriori = open('Archivos/Archivo_2D_Apriori', 'a')
